...
$.jgrid.edit = {
    ...
    msg: {
        ...
        minValue:"стойността трябва да е по-голяма или равна на",
        maxValue:"стойността трябва да е по-малка или равна на",
        email: "не е валиден e-mail адрес",
...
$.jgrid.del = {
    caption: "Изтриване",
    msg: "Да изтрия ли избрания запис?",
    bSubmit: "Изтрий",
    bCancel: "Отказ",
    processData: "Обработка..."
};
$.jgrid.nav = {
	edittext: " ",
    edittitle: "Редакция на избран запис",
	addtext:" ",
    addtitle: "Добавяне на нов запис",
    deltext: " ",
    deltitle: "Изтривнае на избран запис",
    searchtext: " ",
...
$.jgrid.errors = {
	...
	model : "Моделът не съответства на имената!"	
};
$.jgrid.formatter = {
